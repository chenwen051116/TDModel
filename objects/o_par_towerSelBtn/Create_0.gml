...
ds_map_add(global.infoMap, o_spirewallTwr, spirewallT);
...
ds_map_add(global.tutorialInfo, o_spirewallTwr, 	$" Wall with bounce back damage \n Cost: {global.infoMap[? o_spirewallTwr].cost} \n Levelup Cost: {global.infoMap[? o_spirewallTwr].lv_cost} \n Damage:{global.infoMap[? o_spirewallTwr].lv0_d} \n Hp: {global.infoMap[? o_spirewallTwr].hp} \n Each level +Health : {global.infoMap[? o_spirewallTwr].d_h} \n Each level + Damage:{global.infoMap[? o_spirewallTwr].d_d} ")
